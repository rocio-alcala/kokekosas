...
const kokedamaCuidados = [
  {
    ...
    texts: [
      ...
      "La frecuencia dependera del tipo de planta, de la ubicacion de la misma y de la epoca del ano en la que nos encontremos. Intenta siempre mantener la bola de tierra humeda.",
    ],
  ...
  },
  {
    title: "Ubicacion",
    texts: [
      "Para que tus kokedamas prosperen, es importante proporcionarles el entorno adecuado, Coloca tus kokedamas en un lugar donde reciban luz indirecta brillante. Evita la luz solar directa, ya que puede secar el musgo y dañar las raíces de la planta, prefieren temperaturas entre 18°C y 25°C. Mantene tus plantas alejadas de corrientes de aire frío y fuentes de calor como radiadores.",
    ],
